...
class BrachyPlan(object):
    def __init__(self, ds):
        ...
        self.total_treatment_time = self.get_total_treatment_time()
        self.treatment_date = self.get_treatment_date()
        self.file_save_time = self.get_file_save_time()

    def get_file_save_time(self):
        return self.ds[0x0008, 0x0013].value

    def get_treatment_date(self):
        return self.ds[0x0008, 0x0020].value
    ...
    def get_total_treatment_time(self):
        ...
        for channel in self.channels:
            for dwell in channel:
                total_time += dwell.dwell_time
        return total_time
